...
describe('Vigenere cipher', () => {
  ...
  describe('class presence', () => {
    ...
    test('correct inheritance', () => {
      assert.strictEqual(new VigenereCipheringMachine() instanceof VigenereCipheringMachine, true);
    });

    test('has methods', () => {
      assert.strictEqual(VigenereCipheringMachine.prototype.encrypt instanceof Function, true);
      assert.strictEqual(VigenereCipheringMachine.prototype.decrypt instanceof Function, true);
    });
  });
  ...
  describe('base requirements', () => {
    ...
    test('must throw an Error if no args', function () {
      ...
      assert.strictEqual(isThrowingExpectedErrors, true);
    });
