...
describe('Extended repeater', () => {
  ...
  describe('function presence', () => {
    test('function repeater exists', () => {
      assert.strictEqual(typeof repeater, 'function');
    });
  });

  // Functional requirements
  describe('base & functional requirements', () => {
    test('repeats string properly', () => {
    ...
    test('supports missing repeat counters', () => {
      assert.equal(
  ...
  describe('extended requirements ', () => {
    ...
    test('supports different registers & whitespaces & symbols', () => {
      assert.equal(
        repeater('аГуСиК ', {
          repeatTimes: 3,
          separator: '♥♥♥  ',
    ...
    test('supports different str & addition', () => {
      assert.equal(
        repeater(9.234, {
          repeatTimes: 4,
          separator: '||',
    ...
    test('correctly converts str and addition options to string', () => {
